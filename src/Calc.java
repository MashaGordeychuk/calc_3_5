...
//      Заполняем символьный массив символами строки которую ввел пользователь и по ходу ловим знак операции
       ...
       String tnumber1 = tToNumber(stable00);
       String tnumber2 = tToNumber(string03);
       if((tnumber1 =="") || (tnumber2 =="")) {
           System.out.print("Вводимое значение введено не верно, число более 10");
       }else{

           if (tnumber1 != tnumber2){

               System.out.println("Нельзя производить операции между Римскими и Арабскими числами");
               return;
           }
        }
    ...
    private static String  tToNumber (String roman) {
        try {
            if (roman.equals("I")) {
                return "R";
            } else if (roman.equals("II")) {
